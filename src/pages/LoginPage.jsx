...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      const demoGoogleEmail = email || 'admin@pharma.com';
      const res = await fetch('/api/auth/google-auth', {
        ...
        body: JSON.stringify({
          ...
          name: 'Verified Admin',
          googleId: 'google-oauth-2026-sub'
        })
      });
      ...
      <div className="max-w-md w-full glass-panel p-8 relative border-emerald-500/20">
        ...
        <div className="mt-6 pt-5 border-t border-white/10 text-center">
          <button
            ...
            disabled={loading}
            className="w-full btn-secondary justify-center py-2 text-xs font-semibold flex items-center gap-2"
          >
